...
# heroku config:set DJANGO_SETTINGS_MODULE=resume.settings.production
...
if AWS_USE_S3:
    ...
    STATICFILES_STORAGE = 'resume.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'resume.storage_backends.PublicMediaStorage'
